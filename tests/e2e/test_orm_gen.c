...
#if defined(_MSC_VER)
  strncpy_s(no_pk_fields[0].name, sizeof(no_pk_fields[0].name), "val", 63);
#else
  strncpy(no_pk_fields[0].name, "val", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(no_pk_fields[0].type, sizeof(no_pk_fields[0].type), "integer", 31);
#else
  strncpy(no_pk_fields[0].type, "integer", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(no_pk_fields[1].name, sizeof(no_pk_fields[1].name), "obj_index",
            63);
#else
...
#if defined(_MSC_VER)
  strncpy_s(no_pk_fields[1].type, sizeof(no_pk_fields[1].type), "unknown", 31);
#else
  strncpy(no_pk_fields[1].type, "unknown", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(no_pk_fields[1].description, sizeof(no_pk_fields[1].description),
            "[INDEX]", 255);
#else
...
#if defined(_MSC_VER)
  strncpy_s(big_pk_fields[0].name, sizeof(big_pk_fields[0].name), "id", 63);
#else
  strncpy(big_pk_fields[0].name, "id", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(big_pk_fields[0].type, sizeof(big_pk_fields[0].type), "integer",
            31);
#else
...
#if defined(_MSC_VER)
  strncpy_s(big_pk_fields[0].format, sizeof(big_pk_fields[0].format), "int64",
            31);
#else
...
#if defined(_MSC_VER)
  strncpy_s(big_pk_fields[0].description, sizeof(big_pk_fields[0].description),
            "[PK]", 255);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[0].name, sizeof(fields[0].name), "id", 63);
#else
  strncpy(fields[0].name, "id", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[0].type, sizeof(fields[0].type), "integer", 31);
#else
  strncpy(fields[0].type, "integer", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[0].description, sizeof(fields[0].description), "[PK]", 255);
#else
  strncpy(fields[0].description, "[PK]", 255);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[1].name, sizeof(fields[1].name), "username", 63);
#else
  strncpy(fields[1].name, "username", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[1].type, sizeof(fields[1].type), "string", 31);
#else
  strncpy(fields[1].type, "string", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[1].description, sizeof(fields[1].description), "[UNIQUE]",
            255);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[2].name, sizeof(fields[2].name), "email", 63);
#else
  strncpy(fields[2].name, "email", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[2].type, sizeof(fields[2].type), "string", 31);
#else
  strncpy(fields[2].type, "string", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[2].description, sizeof(fields[2].description), "[INDEX]",
            255);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[3].name, sizeof(fields[3].name), "org_id", 63);
#else
  strncpy(fields[3].name, "org_id", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[3].type, sizeof(fields[3].type), "integer", 31);
#else
  strncpy(fields[3].type, "integer", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[3].description, sizeof(fields[3].description), "[FK=Org]",
            255);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[4].name, sizeof(fields[4].name), "score", 63);
#else
  strncpy(fields[4].name, "score", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[4].type, sizeof(fields[4].type), "number", 31);
#else
  strncpy(fields[4].type, "number", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[4].format, sizeof(fields[4].format), "float", 31);
#else
  strncpy(fields[4].format, "float", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[5].name, sizeof(fields[5].name), "is_active", 63);
#else
  strncpy(fields[5].name, "is_active", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[5].type, sizeof(fields[5].type), "boolean", 31);
#else
  strncpy(fields[5].type, "boolean", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[6].name, sizeof(fields[6].name), "profile", 63);
#else
  strncpy(fields[6].name, "profile", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[6].type, sizeof(fields[6].type), "object", 31);
#else
  strncpy(fields[6].type, "object", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[6].ref, sizeof(fields[6].ref), "Profile", 63);
#else
  strncpy(fields[6].ref, "Profile", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[7].name, sizeof(fields[7].name), "data", 63);
#else
  strncpy(fields[7].name, "data", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[7].type, sizeof(fields[7].type), "string", 31);
#else
  strncpy(fields[7].type, "string", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[7].format, sizeof(fields[7].format), "date", 31);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[8].name, sizeof(fields[8].name), "big_id", 63);
#else
  strncpy(fields[8].name, "big_id", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[8].type, sizeof(fields[8].type), "integer", 31);
#else
  strncpy(fields[8].type, "integer", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[8].format, sizeof(fields[8].format), "int64", 31);
#else
  strncpy(fields[8].format, "int64", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[9].name, sizeof(fields[9].name), "small_id", 63);
#else
  strncpy(fields[9].name, "small_id", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[9].type, sizeof(fields[9].type), "integer", 31);
#else
  strncpy(fields[9].type, "integer", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[9].format, sizeof(fields[9].format), "int32", 31);
#else
  strncpy(fields[9].format, "int32", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[10].name, sizeof(fields[10].name), "double_val", 63);
#else
  strncpy(fields[10].name, "double_val", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[10].type, sizeof(fields[10].type), "number", 31);
#else
  strncpy(fields[10].type, "number", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[10].format, sizeof(fields[10].format), "double", 31);
#else
  strncpy(fields[10].format, "double", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[11].name, sizeof(fields[11].name), "datetime_val", 63);
#else
  strncpy(fields[11].name, "datetime_val", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[11].type, sizeof(fields[11].type), "string", 31);
#else
  strncpy(fields[11].type, "string", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[11].format, sizeof(fields[11].format), "date-time", 31);
#else
  strncpy(fields[11].format, "date-time", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[12].name, sizeof(fields[12].name), "unknown_val", 63);
#else
  strncpy(fields[12].name, "unknown_val", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[12].type, sizeof(fields[12].type), "unknown", 31);
#else
  strncpy(fields[12].type, "unknown", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[13].name, sizeof(fields[13].name), "unref_obj", 63);
#else
  strncpy(fields[13].name, "unref_obj", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[13].type, sizeof(fields[13].type), "object", 31);
#else
  strncpy(fields[13].type, "object", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[14].name, sizeof(fields[14].name), "malformed_fk", 63);
#else
  strncpy(fields[14].name, "malformed_fk", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[14].type, sizeof(fields[14].type), "integer", 31);
#else
  strncpy(fields[14].type, "integer", 31);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[14].description, sizeof(fields[14].description),
...
#if defined(_MSC_VER)
  strncpy_s(fields[15].name, sizeof(fields[15].name), "huge_fk", 63);
#else
  strncpy(fields[15].name, "huge_fk", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[15].type, sizeof(fields[15].type), "integer", 31);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[16].name, sizeof(fields[16].name), "bad_json", 63);
#else
  strncpy(fields[16].name, "bad_json", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[16].type, sizeof(fields[16].type), "string", 31);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[17].type, sizeof(fields[17].type), "string", 31);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[18].name, sizeof(fields[18].name), "no_schema_json", 63);
#else
  strncpy(fields[18].name, "no_schema_json", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[18].type, sizeof(fields[18].type), "string", 31);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[19].name, sizeof(fields[19].name), "schema_false_json", 63);
#else
  strncpy(fields[19].name, "schema_false_json", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[19].type, sizeof(fields[19].type), "string", 31);
#else
...
#if defined(_MSC_VER)
  strncpy_s(fields[20].name, sizeof(fields[20].name), "schema_empty_json", 63);
#else
  strncpy(fields[20].name, "schema_empty_json", 63);
#endif

#if defined(_MSC_VER)
  strncpy_s(fields[20].type, sizeof(fields[20].type), "string", 31);
#else
