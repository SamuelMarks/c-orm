...
TEST run_all_api(void) {
  setup_vt();
  TEST_OOM(test_c_orm_validate, 20000);
  TEST_DB(test_c_orm_validate, 500);
  test_mock_vt();
  TEST_OOM(test_c_orm_find_by_id_int32, 20000);
  TEST_DB(test_c_orm_find_by_id_int32, 500);
  TEST_OOM(test_c_orm_find_by_composite_key, 20000);
  TEST_DB(test_c_orm_find_by_composite_key, 500);
  TEST_OOM(test_c_orm_update_by_composite_key, 20000);
  TEST_DB(test_c_orm_update_by_composite_key, 500);
  TEST_OOM(test_c_orm_delete_by_composite_key, 20000);
  TEST_DB(test_c_orm_delete_by_composite_key, 500);
  TEST_OOM(test_c_orm_find_all, 20000);
  TEST_DB(test_c_orm_find_all, 500);
  TEST_OOM(test_c_orm_insert, 20000);
  TEST_DB(test_c_orm_insert, 500);
  TEST_OOM(test_c_orm_save, 20000);
  TEST_DB(test_c_orm_save, 500);
  TEST_OOM(test_c_orm_update, 20000);
  TEST_DB(test_c_orm_update, 500);
  TEST_OOM(test_c_orm_delete, 20000);
  TEST_DB(test_c_orm_delete, 500);
  TEST_OOM(test_c_orm_delete_by_id_int32, 20000);
  TEST_DB(test_c_orm_delete_by_id_int32, 500);
  TEST_OOM(test_c_orm_delete_by_id_string, 20000);
  TEST_DB(test_c_orm_delete_by_id_string, 500);
  TEST_OOM(test_c_orm_update_partial, 20000);
  TEST_DB(test_c_orm_update_partial, 500);
  TEST_OOM(test_c_orm_exists_int32, 20000);
  TEST_DB(test_c_orm_exists_int32, 500);
  TEST_OOM(test_c_orm_exists_string, 20000);
  TEST_DB(test_c_orm_exists_string, 500);
  TEST_OOM(test_c_orm_find_all_paginated, 20000);
  TEST_DB(test_c_orm_find_all_paginated, 500);
  TEST_OOM(test_c_orm_delete_all, 20000);
  TEST_DB(test_c_orm_delete_all, 500);
  TEST_OOM(test_c_orm_find_by_id_string, 20000);
  TEST_DB(test_c_orm_find_by_id_string, 500);
  TEST_OOM(test_c_orm_find_for_update_by_id_string, 20000);
  TEST_DB(test_c_orm_find_for_update_by_id_string, 500);
  TEST_OOM(test_c_orm_find_for_update_by_id_int32, 20000);
  TEST_DB(test_c_orm_find_for_update_by_id_int32, 500);
  TEST_OOM(test_c_orm_find_one_by_string, 20000);
  TEST_DB(test_c_orm_find_one_by_string, 500);
  TEST_OOM(test_c_orm_hydrate_all, 20000);
  TEST_DB(test_c_orm_hydrate_all, 500);
  TEST_OOM(test_c_orm_hydrate_row_from, 20000);
  TEST_DB(test_c_orm_hydrate_row_from, 500);
  TEST_OOM(test_c_orm_hydrate_row, 20000);
  TEST_DB(test_c_orm_hydrate_row, 500);
  TEST_OOM(test_c_orm_hydrate_cache_row, 20000);
  TEST_DB(test_c_orm_hydrate_cache_row, 500);
  TEST_OOM(test_c_orm_execute_raw, 20000);
  TEST_DB(test_c_orm_execute_raw, 500);
  TEST_OOM(test_c_orm_transaction_begin, 20000);
  TEST_DB(test_c_orm_transaction_begin, 500);
  TEST_OOM(test_c_orm_transaction_commit, 20000);
  TEST_DB(test_c_orm_transaction_commit, 500);
  TEST_OOM(test_c_orm_transaction_rollback, 20000);
  TEST_DB(test_c_orm_transaction_rollback, 500);
  TEST_OOM(test_c_orm_savepoint_create, 20000);
  TEST_DB(test_c_orm_savepoint_create, 500);
  TEST_OOM(test_c_orm_savepoint_rollback, 20000);
  TEST_DB(test_c_orm_savepoint_rollback, 500);
  TEST_OOM(test_c_orm_savepoint_release, 20000);
  TEST_DB(test_c_orm_savepoint_release, 500);
  TEST_OOM(test_c_orm_get_field_value, 20000);
  TEST_DB(test_c_orm_get_field_value, 500);
  TEST_OOM(test_c_orm_set_field_value, 20000);
  TEST_DB(test_c_orm_set_field_value, 500);
  TEST_OOM(test_c_orm_hydrate_abstract_all, 20000);
  TEST_DB(test_c_orm_hydrate_abstract_all, 500);
  TEST_OOM(test_c_orm_find_all_abstract, 20000);
  TEST_DB(test_c_orm_find_all_abstract, 500);
  TEST_OOM(test_c_orm_abstract_free, 20000);
  TEST_DB(test_c_orm_abstract_free, 500);
  TEST_OOM(test_c_orm_to_json, 20000);
  TEST_DB(test_c_orm_to_json, 500);
  TEST_OOM(test_c_orm_from_json, 20000);
  TEST_DB(test_c_orm_from_json, 500);
  TEST_OOM(test_c_orm_to_dict, 20000);
  TEST_DB(test_c_orm_to_dict, 500);
  TEST_OOM(test_c_orm_from_dict, 20000);
  TEST_DB(test_c_orm_from_dict, 500);
  TEST_OOM(test_c_orm_abstract_to_json, 20000);
  TEST_DB(test_c_orm_abstract_to_json, 500);
  TEST_OOM(test_c_orm_abstract_from_json, 20000);
  TEST_DB(test_c_orm_abstract_from_json, 500);
  TEST_OOM(test_c_orm_deep_free, 20000);
  TEST_DB(test_c_orm_deep_free, 500);
  TEST_OOM(test_c_orm_deep_copy, 20000);
  TEST_DB(test_c_orm_deep_copy, 500);
  TEST_OOM(test_c_orm_insert_async, 20000);
  TEST_DB(test_c_orm_insert_async, 500);
  TEST_OOM(test_c_orm_find_all_async, 20000);
  TEST_DB(test_c_orm_find_all_async, 500);
  TEST_OOM(test_c_orm_hydrate_routed, 20000);
  TEST_DB(test_c_orm_hydrate_routed, 500);
  TEST_OOM(test_c_orm_config_sqlite_pragma, 20000);
  TEST_DB(test_c_orm_config_sqlite_pragma, 500);
  TEST_OOM(test_c_orm_config_postgres_set, 20000);
  TEST_DB(test_c_orm_config_postgres_set, 500);
  TEST_OOM(test_c_orm_config_mysql_session, 20000);
  TEST_DB(test_c_orm_config_mysql_session, 500);
  TEST_OOM(test_c_orm_shard_manager_init, 20000);
  TEST_DB(test_c_orm_shard_manager_init, 500);
  TEST_OOM(test_c_orm_escape_string, 20000);
  TEST_DB(test_c_orm_escape_string, 500);
  TEST_OOM(test_c_orm_enable_statement_caching, 20000);
  TEST_DB(test_c_orm_enable_statement_caching, 500);
  TEST_OOM(test_c_orm_disable_statement_caching, 20000);
  TEST_DB(test_c_orm_disable_statement_caching, 500);
  TEST_OOM(test_c_orm_lazy_load, 20000);
  TEST_DB(test_c_orm_lazy_load, 500);
  TEST_OOM(test_c_orm_lazy_load_paginated, 20000);
  TEST_DB(test_c_orm_lazy_load_paginated, 500);
  TEST_OOM(test_c_orm_prepare_cached, 20000);
  TEST_DB(test_c_orm_prepare_cached, 500);
  TEST_OOM(test_c_orm_finalize_cached, 20000);
  TEST_DB(test_c_orm_finalize_cached, 500);
  TEST_OOM(test_c_orm_insert_generic, 20000);
  TEST_DB(test_c_orm_insert_generic, 500);
  TEST_OOM(test_c_orm_get_generic, 20000);
  TEST_DB(test_c_orm_get_generic, 500);
  TEST_OOM(test_c_orm_find_all_generic, 20000);
  TEST_DB(test_c_orm_find_all_generic, 500);
  TEST_OOM(test_c_orm_get_generic_string, 20000);
  TEST_DB(test_c_orm_get_generic_string, 500);
  PASS();
}
